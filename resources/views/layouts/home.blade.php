...
@section('content')
    ...
    <div class="mb-2 mt-5">
        ...
        <div class="categories-lists container">
            <div class="row overflow-x-auto" style="height: 325px;">
                <div class="col-lg-2 col-md-4 col-sm-2 m-2 border border-1 rounded-3 border-grey">
                    <img class="h-50 w-100 mt-2 rounded" src="{{ asset('images/meubles/meuble.jpg') }}" alt="First image">
                    <p class="mt-3">Meubles</p>
                    <div class="mt-2">
                        <p class="fs--1">
                            ...
                            <span class="text-500 fw-semi-bold ms-1">(59 people rated)</span>
                        </p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-2 m-2 border border-1 rounded-3 border-grey">
                    <img class="h-50 w-100 mt-2 rounded" src="{{ asset('images/electronics/casque.png') }}" alt="Second image">
                    <p class="mt-3">Casque model MG</p>
                    <div class="mt-2">
                        <p class="fs--1">
                            <svg class="svg-inline--fa fa-star text-warning" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                <path fill="currentColor" d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z"></path>
                ...
                <div class="col-lg-2 col-md-4 col-sm-2 m-2 border border-1 rounded-3 border-grey">
                    <img class="h-50 w-100 mt-2 rounded" src="{{ asset('images/meubles/maison.png') }}" alt="First image">
                    <p class="mt-3">Chaises  à sallon</p>
                    <div class="mt-2">
                        <p class="fs--1">
                            <svg class="svg-inline--fa fa-star text-warning" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                <path fill="currentColor" d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z"></path>
                ...
                <div class="col-lg-2 col-md-4 col-sm-2 m-2 border border-1 rounded-3 border-grey">
                    <img class="h-50 w-100 mt-2 rounded" src="{{ asset('images/vetements/Ref5-2.png') }}" alt="Second image">
                    <p class="mt-3">Vêtements à la mode</p>
                    <div class="mt-2">
                        <p class="fs--1">
                            <svg class="svg-inline--fa fa-star text-warning" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                <path fill="currentColor" d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z"></path>
                ...
                <div class="col-lg-2 col-md-4 col-sm-2 m-2 border border-1 rounded-3 border-grey">
                    <img class="h-50 w-100 mt-2 rounded" src="{{ asset('images/vetements/combi_short_pois.jpg') }}" alt="First image">
                    <p class="mt-3">Combinaison robe</p>
                    <div class="mt-2">
                        <p class="fs--1">
                            <svg class="svg-inline--fa fa-star text-warning" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                <path fill="currentColor" d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z"></path>
